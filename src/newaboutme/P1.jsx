...
const StyledWrapper = styled.div`
  ...
  #card {
    ...
    border-radius: 20px;
    transition: 700ms;
    background: linear-gradient(135deg, #a5a6ff, #9d32d6, #6e1d9c);
...
@media (min-width: 768px) and (max-width: 1024px) {
  ...
  #card::before {
    ...
    //   rgba(0, 0, 0, 0) 70%),  
  background: 
   radial-gradient(circle at 20% 50%, rgba(165, 166, 255, 0.8), transparent 60%),
   linear-gradient(135deg, #c1c2ff, #9d32d6 45%, #4e0d7a);
box-shadow: 0 0 20px rgba(157, 50, 214, 0.6);
        ...
        <div className="flex flex-col md:flex-row items-center justify-center w-full mt-10">
            ...
            <StyledWrapper1>
              <ul className="example-2 ">
                <li className="icon-content">
                  ...
                  <a href="https://www.linkedin.com/in/syedtahaalinaqvi" aria-label="LinkedIn" data-social="linkedin" target="_blank" rel="noopener noreferrer">
                ...
                <li className="icon-content">
                    ...
                    <a href="https://github.com/tahanaqvi14" aria-label="GitHub" data-social="github" target="_blank" rel="noopener noreferrer">
                      <div className="filled" />
                ...
                <li className="icon-content">
                  <a href="https://www.instagram.com/_.tahanaqvi._/" aria-label="Instagram" data-social="instagram" target="_blank" rel="noopener noreferrer">
                    <div className="filled" />
          ...
          <div className="p-8 md:w-1/2 flex flex-col justify-center  mx-4 px-4">
            ...
            <div className="element">
              {[
                { number: ['/react.png','/nodejs.png','/express.png','/mongodb.png'], label: "Tech Stack" },
                { number: "10+", label: "Projects " },
                { number: ["/sql.png",'/mysql.png'], label: "DataBases" },
                { number: ['/java.png','/python.png','/clanguage (2).png'], label: "Languages" },
              ].map((item, index) => (
                <div
                  key={index}
                  className="box"
                >
                  {Array.isArray(item.number) && item.number.length > 1 ? (
                    <div className="flex flex-row space-x-7 justify-center mt-1">
                      {item.number.map((src, index) => (
                        <div className="" key={index}>
                          <img src={src} className="max-h-[30px]" alt={`Logo ${index}`} />
                        </div>
                      ))}
                    </div>
                  ) : (
