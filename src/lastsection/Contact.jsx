...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_d6930zf', 'template_nkwoxd6', e.target, 'B65b85THPngFCeqOn')
          .then(() => {
            // Only reload the page after the email is successfully sent
  ...
  return (
    <div className="container flex flex-col justify-center items-center max-w-full mx-auto py-2 px-4 ">
        <div>
      <h1 className="text-4xl font-bold text-center text-white mb-4">Message Me!</h1>
      <div className="goog mb-12"></div>
        ...
        <div className="card">
            ...
            <div className="comment-container">
                ...
                <div className="user-info">
                    <span>Taha Naqvi</span>
                    <p>Wednesday, April 20th at 8:08pm</p>
                </div>
                </div>
                <p className="comment-content">
                You’ve seen my portfolio. Now, I’m curious,does it leave a mark or fade into the background? Let me know your thoughts.
                </p>
            </div>
            </div>
            <form onSubmit={sendEmail}>
                ...
                <div className="box-container">
                    <textarea placeholder="Reply" defaultValue={""} name="message"/>
                    <div>
                    <div className="formatting">
                        ...
                        <button type="submit" value="Send" className="send" title="Send">
